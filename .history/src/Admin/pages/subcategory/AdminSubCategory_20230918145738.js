  ...
  const deleteHandler = async (id) => {
    try {
      const { data } = await axios.delete(
        `${Baseurl}api/v1/catg/delete/sub/category/649945ec95f8b84b9b46cc49`,
        Auth
      );
    ...
    const postHandler = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          `https://mr-sushruth-backend-ecommerce.vercel.app/api/v1/catg/subcategory`,
          payload,
          Auth
        );
