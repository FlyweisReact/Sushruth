...
const ViewProduct = () => {
  ...
  return (
    <section className="sectionCont">
      ...
      {ValueChecker(data?.category, " Product Name")}

      {data?.deliveryPinCodes &&
        data?.deliveryPinCodes?.map((i, index) => (
          <div className="Desc-Container" key={`Delivery${index}`}>
            <p className="title"> Delivery Code </p>
